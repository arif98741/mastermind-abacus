...
class School_settings extends Admin_Controller
{
    ...
    public function bkash_save()
    {
        ...
        $this->form_validation->set_rules('bkash_app_secret', 'Bkash App Secret Key', 'trim|required');
        $this->form_validation->set_rules('bkash_username', 'Bkash Username', 'trim|required');
        $this->form_validation->set_rules('bkash_password', 'Stripe Password', 'trim|required');
