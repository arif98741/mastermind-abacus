...
<section class="w3l-bootstrap-header">
    <nav class="navbar navbar-expand-lg navbar-light py-lg-2 py-2">
        <div class="container">
            <a class="navbar-brand" href="index.html"> <img src="<?php echo base_url();  ?>assets/front/images/logo.png"
          ...
          <a class="navbar-brand" href="#index.html">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="program-overview.html">PROGRAMME OVERVIEW</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="program-overview.html#faq-section">FAQ</a>
                    </li>
                    <li class="nav-item">
