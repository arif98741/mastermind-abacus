            ...
            <div class="panel-body">
                <div class="row mb-sm">
                    ...
                    <?php if (is_superadmin_loggedin()): ?>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">New Student Admission<span
                                            class="required"></span></label>
                                <select name="new_admission" id="" class="form-control">
                                    <option value="" selected>-</option>
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>
                                </select>
                                <small>This option is for only filtering newly admitted student using online admission form </small>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <section class="panel appear-animation" data-appear-animation="<?= $global_config['animations'] ?>"
                ...
                <header class="panel-heading">
                    <h4 class="panel-title"><i
                                class="fas fa-user-graduate"></i> <?php echo translate('online_admission') . " " . translate('list'); ?>
                    </h4>
                </header>
                            ...
                            <tr>
                                ...
                                <td class="min-w-lg">
                                    <?php if ($row['status'] != 2 && get_permission('online_admission', 'is_add')) { ?>
                                        <a href="<?php echo base_url('online_admission/approved/' . $row['id']); ?>"
                                           class="btn btn-success btn-circle icon" data-toggle="tooltip"
                                           data-original-title="<?= translate('approved') ?>">
                                            <i class="far fa-check-circle"></i>
                                        </a>

                                        <button onclick="confirm_decline('<?php echo base_url('online_admission/decline/' . $row['id']); ?>')"
