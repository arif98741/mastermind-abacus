        ...
        <section class="panel">
            <div class="tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane box active" id="bkash">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="bkash_app_key"
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Bkash App Key</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="bkash_app_secret"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="bkash_username"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="bkash_password"
                            ...
                            <div class="col-md-offset-3 col-md-6 mb-md">
                                <div class="checkbox-replace">
                                    <label class="i-checks">
                                        <input type="checkbox" name="bkash_demo"
                                               id="bkash_demo" <?= ($config['bkash_demo'] == 1 ? 'checked' : ''); ?>>
                                        <i></i> Bkash Demo
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane box " id="paypal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="paypal_username"
                                       value="<?= $config['paypal_username'] ?>">
                                <span class="error"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="paypal_signature"
                                       value="<?= $config['paypal_signature'] ?>">
                                <span class="error"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-3 col-md-6 mb-md">
                                <div class="checkbox-replace">
                                    <label class="i-checks">
                                        <input type="checkbox" name="paypal_sandbox"
                                               id="paypal_sandbox" <?= ($config['paypal_sandbox'] == 1 ? 'checked' : ''); ?>>
                                        <i></i> Paypal Sandbox
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane box" id="stripe">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-3 col-md-6 mb-md">
                                <div class="checkbox-replace">
                                    <label class="i-checks">
                                        <input type="checkbox" name="stripe_demo"
                                               id="stripe_demo" <?= ($config['stripe_demo'] == 1 ? 'checked' : ''); ?>>
                                        <i></i> Stripe Demo
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane box" id="payumoney">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-3 col-md-6 mb-md">
                                <div class="checkbox-replace">
                                    <label class="i-checks">
                                        <input type="checkbox" name="payumoney_demo"
                                               id="payumoney_demo" <?= ($config['payumoney_demo'] == 1 ? 'checked' : ''); ?>>
                                        <i></i> Payumoney Demo
                                    </label>
                                </div>
                            </div>
            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="checkbox-replace">
                            <label class="i-checks">
                                <input type="checkbox" name="bkash_status"
                                       id="bkash_status" <?= ($config['bkash_status'] == 1 ? 'checked' : ''); ?>>
                                <i></i> Bkash
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="checkbox-replace">
                            <label class="i-checks">
                                <input type="checkbox" name="paypal_status"
                                       id="paypal_status" <?= ($config['paypal_status'] == 1 ? 'checked' : ''); ?>>
                                <i></i> Paypal
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="checkbox-replace">
                            <label class="i-checks">
                                <input type="checkbox" name="stripe_status"
                                       id="stripe_status" <?= ($config['stripe_status'] == 1 ? 'checked' : ''); ?>>
                                <i></i> Stripe
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="checkbox-replace">
                            <label class="i-checks">
                                <input type="checkbox" name="payumoney_status"
                                       id="payumoney_status" <?= ($config['payumoney_status'] == 1 ? 'checked' : ''); ?>>
                                <i></i> PayUmoney
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="checkbox-replace">
                            <label class="i-checks">
                                <input type="checkbox" name="paystack_status"
                                       id="paystack_status" <?= ($config['paystack_status'] == 1 ? 'checked' : ''); ?>>
                                <i></i> Paystack
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="checkbox-replace">
                            <label class="i-checks">
                                <input type="checkbox" name="razorpay_status"
                                       id="razorpay_status" <?= ($config['razorpay_status'] == 1 ? 'checked' : ''); ?>>
                                <i></i> Razorpay
                            </label>
                        </div>
                    </div>
